...
Tourism::Tourism(int origem, int destino, double distancia, string labelorigem, string labeldestino) {
...
void Tourism::setDistancia(double n) {
    distancia = n;
}
